        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if ((title.equals(myNote.getTitle()) ||
                    ...
                    AlertDialog.Builder confirmation = new AlertDialog.Builder(EditNote.this);
                    confirmation.setTitle("是否保存？");
                    confirmation.setPositiveButton("保存并返回", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            if (title.trim().equals("")) {
                                title = "无标题";
                    ...
                    confirmation.setNegativeButton("不保存", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            finish();
                        }
