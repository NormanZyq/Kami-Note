...
public abstract class Base {
	...
	public String getLastRequest() {
		return com.example.zyq.kaminotetest.main.java.com.qcloud.Common.Request.getRequestUrl();
	}

	public String getLastResponse() {
		return com.example.zyq.kaminotetest.main.java.com.qcloud.Common.Request.getRawResponse();
	}
	...
	public String generateUrl(String actionName, TreeMap<String, Object> params) {
		...
		return com.example.zyq.kaminotetest.main.java.com.qcloud.Common.Request.generateUrl(params, secretId, secretKey, requestMethod,
	...
	public String call(String actionName, TreeMap<String, Object> params, String fileName){
		...
		String response = com.example.zyq.kaminotetest.main.java.com.qcloud.Common.Request.send(params, secretId, secretKey, requestMethod, serverHost, serverUri, fileName);
		return response;
	}
}
